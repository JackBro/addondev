...
public class MenuDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		createButtion(buttonComposite, "add menu", MenuModel.class);
		createButtion(buttonComposite, "add menupopup", MenuPopupModel.class);
		createButtion(buttonComposite, "add menuitem", MenuItemModel.class);
		createButtion(buttonComposite, "add menuseparator", MenuSeparatorModel.class);
		
		Button fDeleteButton = new Button(buttonComposite, SWT.NONE);
