	...
	function renderBasic(r, c, showNumbers) {
		...
		if (!tbody) { // first time, build all cells from scratch
			...
			for (i=0; i<rowCnt; i++) {
				...
				for (j=0; j<colCnt; j++) {
					s += "<td class='fc-" +
						...
						(showNumbers ? "<div class='fc-day-number'><a href='javascript:void(0);' onclick = 'dayLinkClickEvent(" + d.getFullYear() + "," + d.getMonth() + "," + d.getDate() + ")'>" + d.getDate() + "</a></div>" : '') +
			...
			tbody.find('td').each(function() {
				...
				td.find('div.fc-day-number').html("<a href='javascript:void(0);' onclick = 'dayLinkClickEvent(" + d.getFullYear() + "," + d.getMonth() + "," + d.getDate() + ")'>"+d.getDate()+"<a\>");
