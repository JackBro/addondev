...
public class AddonDevDebugModelPresentation  implements IDebugModelPresentation {
	...
	static public String DEBUG_MODEL_ID = "org.addondev.debug.model";
			 ...
			 try {
				if(breakpoint.isEnabled())
				 { 
					...
					return AddonDevDebugPlugin.getDefault().getImage(AddonDevDebugPlugin.IMG_BP_ENABLE);
				 }
				 else
				 {
					 return AddonDevDebugPlugin.getDefault().getImage(AddonDevDebugPlugin.IMG_BP_DISABLE);
				 }
...
//                String fileName = file.getName();
        ...
        } else if (element instanceof AddonDevDebugTarget || element instanceof AddonDevStackFrame){// || element instanceof JSThread) {
