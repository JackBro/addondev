...
//
//public class JavaScriptCodeScanner extends RuleBasedScanner {
//	
//	private static class GreatKeywordDetector implements IWordDetector {
//
//		@Override
...
//	}
//	
//    final static public String[] KEYWORDS = {
//    		"let", "CC", "function"
//         };
//	
...
//			 
//			Color c= new Color(Display.getCurrent(), new RGB(255, 0, 0));
//			 
//			IToken keywordToken = new Token(new TextAttribute(c, null, SWT.BOLD));
//			//WordPatternRule wpr = new WordPatternRule(new GreatKeywordDetector(), "this", "", keywordToken);
//			 
//			WordRule wr = new WordRule(new GreatKeywordDetector());
//			//String word = "this";
//			//wr.addWord(word , keywordToken);
//
